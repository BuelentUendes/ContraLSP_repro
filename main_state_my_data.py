...
from main_load_my_data import load_or_create_dataset

from torch.utils.data import Dataset
from helper_train_timeseries import TimeSeriesDataset, train_model
    ...
    # np.save('./results/true.npy', true_saliency.detach().numpy())
        ...
        if "gate_mask" in explainers:
            ...
            _attr = explainer.attribute(
                ...
                trainer=trainer,
                mask_net=mask,
                batch_size=x_test.shape[0], # Batch size is 200
                sigma=0.5,
            )
